...
public class MobsHelper {
	...
	public static void setupMobs(){
		...
		EntityRegistry.addSpawn(LagoonSlug.class, 220, 1, 3, EnumCreatureType.creature, BiomesHelper.Lagoon);
		...
		EntityRegistry.addSpawn(Pincer.class, 210, 1, 3, EnumCreatureType.creature, BiomesHelper.Sludge);
		...
		EntityRegistry.addSpawn(LagoonMonster.class, 200, 1, 2, EnumCreatureType.creature, BiomesHelper.Lagoon);
		...
		EntityRegistry.addSpawn(Orthrus.class, 3, 1, 2, EnumCreatureType.creature, BiomesHelper.Sludge);

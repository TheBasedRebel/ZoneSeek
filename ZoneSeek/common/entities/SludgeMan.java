...
public class SludgeMan extends EntityMob{

	public SludgeMan(World par1World) {
		super(par1World);
		this.texture = "/mods/zoneseek/textures/models/sludgeman.png";
		this.moveSpeed = 0.3F;
	 ...
	 protected String getLivingSound()
	   ...
	   // protected int getDropItemId()
	    ...
	    protected void droprareDrop(int par1)
	    {
	    	...
	    	{
	    	case 0:
	    		this.dropItem(ItemsHelper.SludgeStone.itemID, 1);
	    	case 1:
	    		this.dropItem(ItemsHelper.SludgeGem.itemID, this.rand.nextInt(5) +1);
	    	}
	    }
	    ...
	    protected void dropFewItems(boolean par1, int par2)
	    {
	    	...
	    	{
	    		this.dropItem(ItemsHelper.SludgeShard.itemID, 2);
	    	}
	    }

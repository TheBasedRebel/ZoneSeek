...
public class LagoonMonster extends EntityMob{

	public LagoonMonster(World par1World) {
		super(par1World);
		this.texture = "/mods/zoneseek/textures/models/lagoonmonster.png";
		this.moveSpeed = 0.2F;
	 ...
	 protected String getLivingSound()
	  ...
	  //  }
	    ...
	    protected void dropFewItems(boolean par1, int par2)
	    {
	    	...
	    	{
	    		this.dropItem(ItemsHelper.LagoonScale.itemID, 2);
	    	}
	    }
	    ...
	    public boolean attackEntityAsMob(Entity par1Entity)
	    {
	        if (super.attackEntityAsMob(par1Entity))
	        {
	            if (par1Entity instanceof EntityLiving)
	            {
	                ...
	                if (var2 > 0)
	                {
	                    ((EntityLiving)par1Entity).addPotionEffect(new PotionEffect(Potion.confusion.id, var2 * 20, 0));
	                }
	            }

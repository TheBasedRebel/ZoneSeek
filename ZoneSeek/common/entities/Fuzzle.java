...
public class Fuzzle extends EntityMob{

	public Fuzzle(World par1World) {
		super(par1World);
    ...
    protected Entity findPlayerToAttack()
    {
	 ...
	 protected String getLivingSound()
	    ...
	    {
	        this.worldObj.playSoundAtEntity(this, "mob.bat.step", 0.15F, 1.0F);
	    }
	   ...
	   // protected int getDropItemId()
	    ...
	    protected void droprareDrop(int par1)
	    {
	    	...
	    	{
	    	case 0:
	    		this.dropItem(ItemsHelper.FuzzleChop.itemID, 1);
	    	case 1:
	    		this.dropItem(ItemsHelper.FuzzleChop.itemID, this.rand.nextInt(5) +1);
	    	}
	    }
	    ...
	    protected void dropFewItems(boolean par1, int par2)
	    {
	    	...
	    	{
	    		this.dropItem(ItemsHelper.FuzzleChop.itemID, 4);
	    	}
	    }

...
public class Obamadon extends EntityTameable {

	private int force_sync = 50; //Force server and client to sync health!
	
	public Obamadon(World par1World)
    {
        super(par1World);
       
        this.texture = "/mods/zoneseek/textures/models/Obamadon.png";
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setInteger("ObamadonHealth",this.dataWatcher.getWatchableObjectInt(18));
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.health = par1NBTTagCompound.getInteger("ObamadonHealth");
   ...
   //Fixed y, scan two sides of 3d rectangle
    ...
    protected void updateAITick()
    {
    	...
    	if(this.isSitting() == false){
    		...
    		if((this.worldObj.rand.nextInt(20) == 0 && this.getObamadonHealth() < this.getMaxHealth()) || this.worldObj.rand.nextInt(100) == 0)
    		{
    			//System.out.printf("Searching for food %d\n",this.getObamadonHealth()); 
    ...
    public void onLivingUpdate()
    {
        ...
        if(this.force_sync <= 0){
        	...
        	if (!this.worldObj.isRemote)//is CLIENT
        	{
        		...
        		this.health = this.getObamadonHealth();
        	}
    		...
    		if(!this.isTamed())
    		{
    			if (!this.worldObj.isRemote)
    			{
    				if (this.rand.nextInt(2) == 0)
    				{
    					...
    					//System.out.printf("Obamadon tamed by %s has type %d and id %d\n", par1EntityPlayer.username, this.which_girl, this.entityId);
    				}
    				else
    				{

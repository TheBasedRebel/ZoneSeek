...
public class Deux extends EntityMob{

	public Deux(World par1World) {
		super(par1World);
		this.texture = "/mods/zoneseek/textures/models/deux.png";
		this.moveSpeed = 0.3F;
	 ...
	 protected String getLivingSound()
	   ...
	   // protected int getDropItemId()
	    ...
	    protected void droprareDrop(int par1)
	    {
	    	...
	    	case 1:
	    		this.dropItem(ItemsHelper.InfectedStone.itemID, this.rand.nextInt(5) +1);
	    	}
	    }
	    ...
	    protected void dropFewItems(boolean par1, int par2)
	    {
	    	...
	    	{
	    		this.dropItem(ItemsHelper.InfectedStone.itemID, 5);
	    	}
	    }
	    ...
	    public boolean attackEntityAsMob(Entity par1Entity)
	    {
	        if (super.attackEntityAsMob(par1Entity))
	        {
	            if (par1Entity instanceof EntityLiving)
	            {
	                ...
	                if (var2 > 0)
	                {
	                    ((EntityLiving)par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, var2 * 40, 0));
	                }
	            }

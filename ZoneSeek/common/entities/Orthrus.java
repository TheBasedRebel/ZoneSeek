...
public class Orthrus extends EntityTameable
{
    ...
    {
        super(par1World);
        this.texture = "/mods/zoneseek/textures/models/orthrus.png";
        ...
        this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, InfectedPig.class, 16.0F, 200, false));
        this.targetTasks.addTask(5, new EntityAITargetNonTamed(this, InfectedCow.class, 16.0F, 200, false));
    }
    ...
    {
        return this.isTamed() ? "/mods/zoneseek/textures/models/orthrus.png" : (this.isAngry() ? "/mods/zoneseek/textures/models/orthrus.png" : super.getTexture());
    }
    ...
    {
        return ItemsHelper.MasterCrystal.itemID;
    }
     ...
     * the animal type)
     */
    public int isBreedingItem()
    {
        return ItemsHelper.FuzzleChop.itemID;
    }
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof Orthrus))
        {
            return false;
        }
        else
        {
            Orthrus orthrus = (Orthrus)par1EntityAnimal;
            return !orthrus.isTamed() ? false : (orthrus.isSitting() ? false : this.isInLove() && orthrus.isInLove());
        }
    }

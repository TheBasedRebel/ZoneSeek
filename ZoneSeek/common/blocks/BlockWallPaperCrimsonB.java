...
public class BlockWallPaperCrimsonB extends Block{
...
public BlockWallPaperCrimsonB(int ID) {
...
{
         this.blockIcon = par1IconRegister.registerIcon("zoneseek:wpcrimsonb");
     	this.topIcon  = par1IconRegister.registerIcon("zoneseek:wpcrimsontop");
    	this.sideIcon = par1IconRegister.registerIcon("zoneseek:wpcrimsonb");

...
public class BlockWallPaperGrayB extends Block{
...
public BlockWallPaperGrayB(int ID) {
...
{
         this.blockIcon = par1IconRegister.registerIcon("zoneseek:wpgrayb");
     	this.topIcon  = par1IconRegister.registerIcon("zoneseek:wpgraytop");
    	this.sideIcon = par1IconRegister.registerIcon("zoneseek:wpgrayb");

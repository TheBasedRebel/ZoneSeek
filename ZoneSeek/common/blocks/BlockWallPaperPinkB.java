...
public class BlockWallPaperPinkB extends Block{
...
public BlockWallPaperPinkB(int ID) {
...
{
         this.blockIcon = par1IconRegister.registerIcon("zoneseek:wppinkb");
     	this.topIcon  = par1IconRegister.registerIcon("zoneseek:wppinktop");
    	this.sideIcon = par1IconRegister.registerIcon("zoneseek:wppinkb");

...
public class BlockPrehistoricLeaf extends BlockLeavesBase implements IShearable
{
	int[] adjacentTreeBlocks;

	public BlockPrehistoricLeaf(int blockId)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("zoneseek:PrehistoricLeaf");
	}
	...
	public ArrayList<ItemStack> onSheared(ItemStack item, World world, int X, int Y, int Z, int fortune)
	{
		...
		ret.add(new ItemStack(BlocksHelper.PrehistoricLeaf.blockID, 1, world.getBlockMetadata(X, Y, Z)));
		return ret;
	}

...
{
	public BlockLagoonSapling(int blockId)
	{
		super(blockId);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("zoneseek:lagoonsapling");
	}
	...
	{
		int metadata = world.getBlockMetadata(x, y, z);
		Object worldGenObject = new WorldGenLagoonTree(false, 15, 0, 0);
		int var8 = 0;
		int var9 = 0;

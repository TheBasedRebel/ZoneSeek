    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if (var81 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var82 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var83 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var84 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var85 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var86 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var87 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var88 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var89 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var90 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }

                if (var91 != BlocksHelper.PrehistoricGrass.blockID)
                {
                    return false;
                }
                ...
                if ((var8 == BlocksHelper.PrehistoricGrass.blockID || var8 == BlocksHelper.PrehistoricDirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11 + 10, var16, BlocksHelper.PrehistoricLeaf.blockID, this.metaLeaves);
                                    this.setBlockAndMetadata(par1World, var14, var11 + 6, var16, BlocksHelper.PrehistoricLeaf.blockID, this.metaLeaves);
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
							//1
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 1), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 2), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 3), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 4), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var6 + 5), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 - 1, par4 + var11, par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 1, par4 + var11, par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							
							//2
                            this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 2), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 2), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 2), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 2), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							
							//3
                            this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 4), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 4), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 4), par5 - 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 - 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 - 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 4), par5 + 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 4), par5 + 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 4), par5 + 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							...
							//4
							this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 6), par5 - 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 6), par5 + 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 2, par4 + (var11 / 6), par5 - 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 - 2, par4 + (var11 / 6), par5 + 2, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 6), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 6), par5, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 6), par5 - 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
                            this.setBlockAndMetadata(par1World, par3, par4 + (var11 / 6), par5 + 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							
							//5
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 8), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 3, par4 + (var11 / 8), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 8), par5 - 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 3, par4 + (var11 / 8), par5 + 1, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 8), par5 - 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 8), par5 - 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 - 1, par4 + (var11 / 8), par5 + 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);
							this.setBlockAndMetadata(par1World, par3 + 1, par4 + (var11 / 8), par5 + 3, BlocksHelper.PrehistoricLog.blockID, this.metaWood);

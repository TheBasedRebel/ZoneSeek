...
public class ChunkProviderPrehistoric implements IChunkProvider {
    ...
    public ChunkProviderPrehistoric(World par1World, long par2)
    {
                    ...
                    for (int l1 = 0; l1 < 4; ++l1)
                    {
                        ...
                        for (int i2 = 0; i2 < 8; ++i2)
                        {
                            ...
                            for (int k2 = 0; k2 < 8; ++k2)
                            {
                                ...
                                if (d15 > 0.0D)
                                {
                                    l2 = BlocksHelper.SludgeStoneGround.blockID;//main block on island
                                }
    ...
    public void replaceBlocksForBiome(int par1, int par2, short[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                int j1 = -1;
                short b1 = ((BiomeGenPrehistoric)biomegenbase).sTopBlock;
                short b2 = ((BiomeGenPrehistoric)biomegenbase).sFillerBlock;
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == BlocksHelper.SludgeStoneGround.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (short)BlocksHelper.SludgeStoneGround.blockID;
                                }
                                else if (k1 >= b0 - 4 && k1 <= b0 + 1)
                                {
                                    b1 = ((BiomeGenPrehistoric)biomegenbase).sTopBlock;
                                    b2 = ((BiomeGenPrehistoric)biomegenbase).sFillerBlock;
                                }
                            ...
                            else if (j1 > 0)
                            {
                                ...
                                if (j1 == 0 && b2 == BlocksHelper.SludgeStoneGround.blockID)
                                {

...
public class BiomeDecoratorPrehistoric extends BiomeDecorator{
	...
	//public boolean 
	private WorldGenPrehistoricTree treeGenerator;
	private WorldGenPrehistoricTallGrass grassGenerator;

	public BiomeDecoratorPrehistoric(BiomeGenBase par1BiomeGenBase)
    {
		super(par1BiomeGenBase);
    	
        this.sandGen = new WorldGenSand(7, BlocksHelper.PrehistoricSand.blockID);
        this.gravelAsSandGen = new WorldGenSand(6, BlocksHelper.PrehistoricSand.blockID);
        this.dirtGen = new WorldGenMinable(BlocksHelper.PrehistoricDirt.blockID, 32);
        this.gravelGen = new WorldGenMinable(BlocksHelper.PrehistoricSand.blockID, 32);
        ...
        this.treeGenerator = new WorldGenPrehistoricTree(false, 40, 0, 0);
        ...
        **/
        ...
        if (doGen && this.generateLakes)
        {
            for (j = 0; j < 50; ++j)
            {
                ...
                i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
                (new WorldGenLiquids(BlocksHelper.PrehistoricSand.blockID)).generate(this.currentWorld, this.randomGenerator, k, l, i1);
            }

...
public class ItemInfectedBoots extends ItemArmor implements IArmorTextureProvider
{
	private Icon icon;
	private String n;
	public ItemInfectedBoots(int itemID,EnumArmorMaterial armorMaterial, int renderIndex, int armorType, String name)
	{

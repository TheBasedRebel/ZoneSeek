...
public class ItemInfectedHelmet extends ItemArmor implements IArmorTextureProvider
{
	private Icon icon;
	private String n;
	public ItemInfectedHelmet(int itemID,EnumArmorMaterial armorMaterial, int renderIndex, int armorType, String name)
	{

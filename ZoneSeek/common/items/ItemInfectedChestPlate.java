...
public class ItemInfectedChestPlate extends ItemArmor implements IArmorTextureProvider
{
	private Icon icon;
	private String n;
	public ItemInfectedChestPlate(int itemID,EnumArmorMaterial armorMaterial, int renderIndex, int armorType, String name)
	{
